...
- Add a new day
- Remove a day
- Add comments to a specific day
- Search comments by keyword
- Display all days and their comments
...
- Reinforce understanding of pointers/references
...
- How to translate low-level logic (C) into Java
